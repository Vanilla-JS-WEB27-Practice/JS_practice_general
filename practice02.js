...
// Work:
// modified solution from BlueAlps edabit user 
// returnUnique = (a) => a.filter(x => a.indexOf(x) === a.lastIndexOf(x));


// first pass
// const returnUnique = (a) => {
//   const result = [];
//   a.map(x => a.indexOf(x) == a.lastIndexOf(x) ? result.push(x) : null);
//   return result
// }
